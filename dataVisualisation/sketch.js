...
function setup() {
  ...
  textAlign(CENTER);
  textSize(18);
  text("Plymouth Temperature: " + weather.main.temp + "°C", width/2, height/4);
  text("Athens Humidity: " + weather2.main.humidity + "%", width/2, height/2);
  text("Shanghai Wind Speed: " + weather3.wind.speed + "mph", width/2, 3*height/4);
  noLoop();
}
